...
const App: React.FC = () => {
  ...
  const handleApplySettings = () => {
    const cleaned = googleClientId.trim();
    localStorage.setItem('sentinal_google_client_id', cleaned);
            ...
            <div className="p-4 space-y-4">
               <div>
                  ...
                  <div className="flex justify-between mt-2">
                    <button onClick={() => setGoogleClientId(DEFAULT_CLIENT_ID)} className="win95-button !text-[10px]">Restore Default</button>
